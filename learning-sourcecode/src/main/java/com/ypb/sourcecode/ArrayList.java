...
public class ArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, Serializable {
    ...
    /**
     * 默认的空的数组 当用户没有指定ArrayList的容量时(即调用无参构造方法)，返回的是该数组-->刚创建一个ArrayList时，其内部数据量为0
     ...
     * @throws NullPointerException          if the specified operator is null or if the operator
     *                                       result is a null value and this list does not permit
     ...
     * specified comparator (that is, {@code c.compare(e1, e2)} must not throw a {@code
     * ClassCastException} for any elements {@code e1} and {@code e2} in the list).
     * <p>
     * <p>If the specified comparator is {@code null} then all elements in this
     * list must implement the {@link Comparable} interface and the elements' {@linkplain Comparable
     ...
     *                                       if the comparator is found to violate the {@link
     *                                       Comparator} contract
     ...
     * descending order in its input array, and can take advantage of ascending and descending order
     * in different parts of the same input array.  It is well-suited to merging two or more sorted
     * arrays: simply concatenate the arrays and sort the resulting array.
     * <p>
     ...
     * {@link Spliterator#ORDERED}.  Implementations should document the reporting of additional
